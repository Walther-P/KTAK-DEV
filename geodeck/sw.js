const VERSION='0.3.1',CACHE='geodeck-shell-'+VERSION;
const SHELL=['./','./index.html','./styles.css?v='+VERSION,'./app.js?v='+VERSION,'./core.js?v='+VERSION,'./layers.js?v='+VERSION,'./drive.js?v='+VERSION,'./routes-provider.js?v='+VERSION,'./drive-core.js?v='+VERSION,'./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
